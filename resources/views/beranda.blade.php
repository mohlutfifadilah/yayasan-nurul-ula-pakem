                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 text-left">
                                        <div class="big-tagline">
                                            ...
                                            {{-- <a data-scroll href="#tentang" class="hover-btn-new"><span>Tentang Kami</span></a>
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <a data-scroll href="#kontak" class="hover-btn-new"><span>Kontak</span></a> --}}
                                        </div>
                                    </div>
                                </div><!-- end row -->
                            </div><!-- end container -->
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                    <div class="message-box" id="tentang">
