		...
		<div class="carousel-inner" role="listbox">
            ...
            @endphp
                <div class="carousel-item @if($index === 0) active @endif">
                    <div id="home" class="first-section" style="background-image:url('{{ asset('storage/kegiatan/' . $profil->nama . '/' . $k->foto) }}');">
                        <div class="dtab">
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 text-left">
                                        <div class="big-tagline">
                                            <h2 data-animation="animated zoomInRight">Yayasan  <strong>Nurul Ula Pakem</strong></h2>
                                            <p class="lead" data-animation="animated fadeInLeft">Sumber informasi mengenai satuan Yayasan Nurul Ula Pakem. </p>
                                            <a href="/tentang" class="hover-btn-new"><span>Tentang Kami</span></a>
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <a href="/kontak" class="hover-btn-new"><span>Kontak</span></a>
                                        </div>
                                    </div>
                                </div><!-- end row -->
                            </div><!-- end container -->
        ...
        <div class="container">
            {{-- <div class="section-title row text-center">
                <div class="col-md-8 offset-md-2">
                    <h3>Tentang</h3>
                    <p class="lead">Yayasan Nurul Ula merupakan satuan yayasan pendidikan. Berkedudukan di Daerah Istimewa Yogyakarta yang terdari PAUD, RA dan MI.</p>
                </div>
            </div><!-- end title --> --}}
            ...
            <div class="row align-items-center">
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                    <div class="message-box">
                        ...
                        <h2>Yayasan Nurul Ula Pakem</h2>
                        <p>Yayasan Nurul Ula Pakem adalah lembaga pendidikan terpadu yang berlokasi di Daerah Istimewa Yogyakarta. Sebagai satuan yayasan pendidikan, Nurul Ula berkomitmen memberikan pendidikan yang berkualitas dan menyeluruh, mengedepankan pendekatan pembelajaran yang mengembangkan karakter, kemandirian, serta potensi akademis anak-anak sesuai dengan jenjang usia mereka.</p>

                        <p> Dengan dukungan tenaga pengajar yang profesional dan lingkungan belajar yang nyaman, Yayasan Nurul Ula berperan aktif dalam membentuk generasi penerus yang berakhlak mulia, kreatif, dan berprestasi. </p>

                        <a href="/tentang" class="hover-btn-new orange"><span>Selengkapnya</span></a>
                    </div><!-- end messagebox -->
                </div><!-- end col -->

				<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                    <div class="post-media wow fadeIn">
                        <img src="{{ asset('hiasan1.jpg') }}" alt="" class="img-fluid img-rounded">
                    </div><!-- end media -->
                </div><!-- end col -->
			</div>
			{{-- <div class="row align-items-center">
		...
		<div class="container">
			<div class="row text-left stat-wrap">
				...
				<div class="col-md-4 col-sm-4 col-xs-12">
					...
					<p class="stat_count">{{ $count_pegawai }}</p>
					<h3>Tenaga Pengajar</h3>
				</div><!-- end col -->

				<div class="col-md-4 col-sm-4 col-xs-12">
					<span data-scroll class="global-radius icon_wrap effect-1 alignleft"><i class="flaticon-years"></i></span>
					<p class="stat_count">{{ $count_kegiatan }}</p>
					<h3>Kegiatan</h3>
				</div><!-- end col -->
			</div><!-- end row -->
		</div><!-- end container -->
