...
@include('admin.template.header')
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Tambah Data Artikel - {{ $profil->nama }}</h1>

                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <form action="{{ route('artikel-store', ['jenjang' => $profil->nama, 'id' => $profil->id]) }} " method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="text-center mb-3">
                                            <img id="profileImage" src="" alt="Belum ada Thumbnail" class="img-fluid mx-auto" style="width: 150px; height: 150px; display: none;">
                                            <h6 class="mt-5" id="noProfileImageText">Belum ada Thumbnail</h6>
                                            <br>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @if(session('judul')) is-invalid @endif @error('judul') is-invalid @enderror" id="judul" placeholder="Judul" name="judul" aria-describedby="judul" value="{{ old('judul') }}">
                                            @error('judul')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea id="summernote" name="isi" class="form-control @if(session('isi')) is-invalid @endif @error('isi') is-invalid @enderror">{{ old('isi') }}</textarea>
                                            @error('isi')
